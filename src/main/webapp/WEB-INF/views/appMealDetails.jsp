            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="mt-4 ml-4 mr-4">
                    <div class="row border-bottom border-3">
                        ...
                        <div class="col d-flex justify-content-end mb-2"><a href="${pageContext.request.contextPath}/app/meal/list" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Back</a></div>
                    </div>

                    <table class="table borderless">
                        <tbody>
                        <tr class="d-flex">
                            <th scope="row" class="col-2">Meal name</th>
                            <td class="col-7">
                                ${mealDto.name}
                            </td>
                        </tr>
                        ...
                        <tr class="d-flex">
                            <th scope="row" class="col-2">Meal calories</th>
                            <td class="col-7">
                                ${mealDto.mealCalories}
                            </td>
                        </tr>
                        <tr class="d-flex">
                            <th scope="row" class="col-2">Meal carbs</th>
                            <td class="col-7">
                                ${mealDto.mealCalories}
                            </td>
                        </tr>
                        <tr class="d-flex">
                            <th scope="row" class="col-2">Meal fats</th>
                            <td class="col-7">
                                ${mealDto.mealFats}
                            </td>
                        </tr>
                        <tr class="d-flex">
                            <th scope="row" class="col-2">Meal protein</th>
                            <td class="col-7">
                                ${mealDto.mealProtein}
                            </td>
                        </tr>
