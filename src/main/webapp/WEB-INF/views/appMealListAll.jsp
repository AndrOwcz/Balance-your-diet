...
<script>
    function checkIfCopy(mealId, name, userId, mealOwnerId) {
        ...
        if (userId !== mealOwnerId) {
            ...
            alert(mealId + name + userId + mealOwnerId + "This is already your meal.");
    ...
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        <div class="row border-bottom border-3 p-1 m-1">
            ...
            <div class="col noPadding d-flex justify-content-end mb-2"><a
                    ...
                    class="btn btn-success rounded-0 pt-0 pb-0 pr-4 pl-4">Add meal</a></div>
        </div>
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-3 d-flex align-items-center justify-content-center flex-wrap">
                        ...
                        <a href="#" onclick="checkIfCopy(${meal.id}, '${meal.name}',${userDto.id}, ${meal.userDto.id})"
                           class="btn btn-secondary rounded-0 text-light m-1">Copy to your meals</a>
                        <a href="/app/meal/comment/${meal.id}" class="btn btn-info rounded-0 text-light m-1">Details</a>
                    </td>
                </tr>
                </tbody>
            </c:forEach>
